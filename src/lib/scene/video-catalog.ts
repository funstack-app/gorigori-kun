...
export const cameraMovementOptions: SceneOption[] = [
  none,
  { value: "静止", hint: "絵を固定して見せる", visual: "camera-cinema", video: "/scene-videos/camera-static.webm" },
  { value: "パン左", hint: "画面を左へ振る", visual: "camera-cinema", video: "/scene-videos/camera-pan-left.webm" },
  { value: "パン右", hint: "画面を右へ振る", visual: "camera-cinema", video: "/scene-videos/camera-pan-right.webm" },
  ...
  { value: "ドリーイン", hint: "被写体へ寄る", visual: "focal", video: "/scene-videos/camera-dolly-in.webm" },
  { value: "ドリーアウト", hint: "被写体から離れる", visual: "focal", video: "/scene-videos/camera-dolly-out.webm" },
  { value: "トラッキング", hint: "被写体に並走", visual: "camera-digital", video: "/scene-videos/camera-tracking.webm" },
  { value: "クレーン", hint: "大きく上下移動", visual: "frame-aerial", video: "/scene-videos/camera-crane.webm" },
...
export const subjectMotionOptions: SceneOption[] = [
  ...
  { value: "近づく", hint: "前進系", visual: "style", video: "/scene-videos/motion-approach.webm" },
  { value: "離れる", hint: "後退系", visual: "style", video: "/scene-videos/motion-recede.webm" },
  ...
  { value: "見渡す", hint: "振り返り", visual: "style", video: "/scene-videos/motion-scan.webm" },
  ...
  { value: "倒れる", hint: "落下・着地", visual: "style", video: "/scene-videos/motion-fall.webm" },
...
export const environmentMotionOptions: SceneOption[] = [
  none,
  { value: "風で草が揺れる", hint: "草原・髪・布が揺れる", visual: "none", video: "/scene-videos/env-wind.webm" },
  { value: "煙が立ち込める", hint: "煙・湯気が漂う", visual: "none", video: "/scene-videos/env-smoke.webm" },
  { value: "水面の反射", hint: "濡れた路面・水面の揺らぎ", visual: "none", video: "/scene-videos/env-water.webm" },
