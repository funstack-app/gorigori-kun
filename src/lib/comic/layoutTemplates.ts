 ...
 * 座標はページ左上原点の percent（0-100）。gutter 約3%・外周マージン約4%を織り込み済み。
 *
...
export const COMIC_LAYOUT_TEMPLATES: ComicLayoutTemplate[] = [
  {
    ...
    slots: [
      ...
      poly([34, 4], [64, 4], [62, 27], [36, 28]),
      poly([4, 4], [31, 4], [33, 28], [4, 29]),
      poly([4, 32], [96, 29], [96, 68], [4, 66]),
      poly([53, 70], [96, 71], [96, 96], [51, 96]),
      poly([4, 69], [50, 70], [48, 96], [4, 96]),
    ],
  ...
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([61, 4], [96, 4], [96, 26], [58, 28]),
      poly([4, 4], [58, 4], [55, 28], [4, 30]),
      poly([4, 33], [96, 29], [96, 64], [4, 62]),
      poly([51, 66], [96, 67], [96, 96], [53, 96]),
      poly([4, 65], [48, 66], [50, 96], [4, 96]),
    ],
  ...
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([48, 4], [96, 4], [96, 48], [55, 54]),
      poly([4, 4], [45, 4], [50, 38], [4, 36]),
      poly([4, 39], [51, 41], [54, 64], [4, 66]),
      poly([56, 57], [96, 52], [96, 62], [57, 64]),
      poly([4, 69], [96, 65], [96, 96], [4, 96]),
    ],
    roles: [
      "起（大ゴマで引き込む）",
      "承",
  ...
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([48, 4], [96, 4], [96, 26], [47, 28]),
      poly([4, 4], [45, 4], [44, 28], [4, 29]),
      poly([48, 31], [96, 29], [96, 67], [65, 66]),
      poly([4, 32], [45, 31], [62, 66], [4, 65]),
      poly([51, 69], [96, 70], [96, 96], [49, 96]),
      poly([4, 68], [48, 69], [46, 96], [4, 96]),
    ],
  ...
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([58, 4], [96, 4], [96, 31], [61, 30]),
      poly([4, 4], [55, 4], [58, 29], [4, 27]),
      poly([4, 30], [96, 34], [96, 62], [4, 64]),
      poly([53, 66], [96, 65], [96, 96], [50, 96]),
      poly([4, 67], [50, 66], [47, 96], [4, 96]),
    ],
    roles: ["起", "承", "見せ場（大ゴマ）", "転", "結（オチ）"],
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([64, 4], [96, 4], [96, 27], [64, 30]),
      poly([4, 4], [61, 4], [61, 31], [4, 35]),
      poly([4, 38], [96, 30], [96, 63], [4, 65]),
      poly([45, 67], [96, 66], [96, 96], [44, 96]),
      poly([4, 68], [42, 67], [41, 96], [4, 96]),
    ],
    roles: ["起", "承", "見せ場（大ゴマ）", "転", "結（オチ）"],
  },
  {
  ...
  },
  {
    ...
    slots: [
      ...
      poly([4, 31], [96, 34], [96, 56], [4, 70]),
      poly([53, 66], [96, 59], [96, 96], [51, 96]),
      poly([4, 73], [50, 67], [48, 96], [4, 96]),
    ],
