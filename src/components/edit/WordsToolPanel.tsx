 ...
 * ことばで追加 (SAM3) の入力パネル。
 *
 * 分解の入り口はキャンバス中央の「レイヤーに分解する」(EditPrimaryAction) の1つだけ
 * (2026-07-09 STΛCK指摘「メニューが多くてどれを押せばいいかわからない」対応)。
 * このパネルは分解後に「足りないものを言葉で追い足す」補助専用。日本語で入力すると
