 ...
 * 座標はページ左上原点の percent（0-100）。左右は紙端まで断ち切り、
 * gutter 3%・上下外周マージン4%で全テンプレ共通。
 * 斜め段の紙端側Yは、左右へ延長した後も代表ガターが3.00%になるよう微調整する。
 *
...
export const COMIC_LAYOUT_TEMPLATES: ComicLayoutTemplate[] = [
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([67, 4], [100, 4], [100, 26.0395], [65, 27]),
      poly([34, 4], [64, 4], [62, 27.03], [36, 28]),
      poly([0, 4], [31, 4], [33, 28], [0, 28.9599]),
      poly([0, 31.97], [100, 29], [100, 68], [0, 65.99]),
      poly([53, 70], [100, 71.06], [100, 96], [51, 96]),
      poly([0, 69], [50, 69.99], [48, 96], [0, 96]),
    ],
  ...
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([61, 4], [100, 4], [100, 25.93], [58, 27.93]),
      poly([0, 4], [58, 4], [55, 27.97], [0, 29.97]),
      poly([0, 33.05932], [100, 29.09816], [100, 63.99], [0, 62.01]),
      poly([51, 66.01], [100, 66.9998], [100, 96], [53, 96]),
      poly([0, 64.99], [48, 65.98], [50, 96], [0, 96]),
    ],
  ...
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([46, 4], [100, 4], [100, 30], [49, 30]),
      poly([0, 4], [43, 4], [46, 30], [0, 30]),
      { x: 0, y: 33, w: 100, h: 31 },
      poly([65, 67], [100, 67], [100, 96], [62, 96]),
      poly([0, 67], [62, 67], [59, 96], [0, 96]),
    ],
    roles: ["起", "承", "見せ場（大ゴマ）", "転", "結（オチ）"],
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([48.01, 4], [100, 4], [100, 48.29], [55.54, 54.21]),
      poly([0, 4], [45.06, 4], [50.06, 38], [0, 36.01]),
      poly([0, 38.99], [50.59, 41.05], [53.94, 63.99], [0, 65.99937]),
      poly([55.89, 56.73], [100, 51.72], [100, 61.971265], [56.93, 63.95]),
      poly([0, 69.06], [100, 65.11], [100, 96], [0, 96]),
    ],
    roles: [
      "起（大ゴマで引き込む）",
      "承",
  ...
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([48, 4], [100, 4], [100, 26.01], [47, 28.01]),
      poly([0, 4], [45, 4], [44, 28.01], [0, 29.01]),
      poly([48, 30.99], [100, 28.99], [100, 67.07], [65, 66.07]),
      poly([0, 31.99], [45, 31], [62, 66.05], [0, 65.07]),
      poly([51, 68.95], [100, 69.91444], [100, 96], [49, 96]),
      poly([0, 67.95871], [48, 68.94], [46, 96], [0, 96]),
    ],
  ...
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([58.02, 4], [100, 4], [100, 30.81386], [61.02, 29.85]),
      poly([0, 4], [54.98, 4], [57.98, 29.13], [0, 27.10314]),
      poly([0, 29.87], [100, 34.17], [100, 62.02], [0, 64]),
      poly([53, 65.98], [100, 64.9906], [100, 96], [50, 96]),
      poly([0, 67.01], [50, 66], [47, 96], [0, 96]),
    ],
    roles: ["起", "承", "見せ場（大ゴマ）", "転", "結（オチ）"],
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([63.99, 4], [100, 4], [100, 27.1256], [64, 30.03]),
      poly([0, 4], [61.01, 4], [60.98, 30.77], [0, 34.843542]),
      poly([0, 38.31], [100, 30.1], [100, 62.97], [0, 64.94]),
      poly([45, 67.02], [100, 66.01], [100, 96], [44, 96]),
      poly([0, 68.03], [42, 67.03], [41, 96], [0, 96]),
    ],
    roles: ["起", "承", "見せ場（大ゴマ）", "転", "結（オチ）"],
  },
  {
  ...
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([0, 4], [100, 4], [100, 31], [0, 28]),
      poly([0, 31], [100, 34], [100, 56.15], [0, 70.33]),
      poly([53, 65.96], [100, 59.0046], [100, 96], [51.01, 96]),
      poly([0, 72.79], [49.96, 66.79], [47.99, 96], [0, 96]),
    ],
  ...
  },
  {
    ...
    pageAspect: { w: 3, h: 4 },
    slots: [
      poly([53, 4], [100, 4], [100, 32], [50, 32]),
      poly([0, 4], [50, 4], [47, 32], [0, 32]),
      poly([49, 35], [100, 35], [100, 64], [52, 64]),
      poly([0, 35], [46, 35], [49, 64], [0, 64]),
      poly([53, 67], [100, 67], [100, 96], [50, 96]),
      poly([0, 67], [50, 67], [47, 96], [0, 96]),
    ],
