...
export const PAGE_TOURS = {
  ...
  settingsConnections: {
    ...
    steps: [
      ...
      {
        target: '[data-tour="settings-panel-basic"]',
        title: "基本設定を整える",
        body: "文字サイズ、はじめてガイド、既定のAIモデル、作業フォルダなどを決めます。文字サイズとはじめてガイドは、変更するとすぐ反映されます。",
        placement: "right",
        beforeAction: { type: "settings-tab", tab: "basic" },
      },
      {
        target: '[data-tour="settings-panel-storage"]',
        title: "保存先と容量を確認する",
        body: "生成画像などの保存場所と、種類ごとの使用量を確認する画面です。保存先を変える前は、画面の説明とバックアップ状態を確認してください。",
        placement: "left",
        beforeAction: { type: "settings-tab", tab: "storage" },
      },
      {
        target: '[data-tour="settings-panel-storage"]',
      ...
      {
        target: '[data-tour="settings-panel-accounts"]',
        title: "アカウントの状態を確認する",
        body: "まずCodexのログイン状態を確認します。HiggsfieldやMagnificは必要な機能を使うときだけ接続し、問題があればテスト接続で確かめます。",
        placement: "left",
        beforeAction: { type: "settings-tab", tab: "accounts" },
      },
      {
        target: '[data-tour="settings-panel-connections"]',
        title: "外部サービスを接続する",
        body: "MCPという共通の窓口から、画像・動画などの外部サービスを追加する画面です。使うサービスだけ接続すれば大丈夫です。",
        placement: "left",
        beforeAction: { type: "settings-tab", tab: "connections" },
      },
      {
        target: '[data-tour="settings-panel-diagnostics"]',
        title: "動かない原因をまとめて診断する",
        body: "「診断を実行」でアプリ、Codex、通信、接続先、一時データを確認します。診断だけでは設定や作品を変更せず、報告用の情報をコピーできます。",
        placement: "left",
        beforeAction: { type: "settings-tab", tab: "diagnostics" },
      },
    ],
  },
